    ...
    <p>
        <table border="0" cellpadding="0" cellspacing="0" 
            ...
            <tbody style="margin: 0px; padding: 0px;">
                ...
                <tr style="margin: 0px; padding: 0px;">
                    <td style="margin: 0px; padding: 0px 0px 20px; width: 449px;" valign="top">
                            ...
                            <tbody style="margin: 0px; padding: 0px;">
                                <tr style="margin: 0px; padding: 0px;">
                                    <td height="121" style="margin: 0px; padding: 0px;" valign="top" width="180">
                                        <div style="margin: 0px; padding: 0px; position: relative; width: 180px; height: 121px;">
                                            ...
                                            <img height="121" 
                                                ...
                                                style="margin: 0px; padding: 0px; border: none;" title="Nissan" width="180" /></a></div>
                                    </td>
                                    <td style="margin: 0px; padding: 0px;" valign="top" width="8">
                                    </td>
                                    <td style="margin: 0px; padding: 0px; font-size: 11px;" valign="top" 
                                        width="150">
                                        <table cellpadding="0" cellspacing="0" style="margin: 0px; padding: 0px;">
                                            <tbody style="margin: 0px; padding: 0px;">
                                                <tr style="margin: 0px; padding: 0px;">
                                    ...
                                    <td height="121" style="margin: 0px; padding: 0px;" valign="top" width="180">
                                        <div style="margin: 0px; padding: 0px; position: relative; width: 180px; height: 121px;">
                                            ...
                                            <img height="121" 
                                                ...
                                                style="margin: 0px; padding: 0px; border: none;" title="Seat" width="180" /></a></div>
                                    </td>
                                    <td style="margin: 0px; padding: 0px;" valign="top" width="8">
                                    </td>
                                    <td style="margin: 0px; padding: 0px; font-size: 11px;" valign="top" 
                        ...
                        <table cellpadding="0" cellspacing="0" style="margin: 0px; padding: 0px;">
                            <tbody style="margin: 0px; padding: 0px;">
                                <tr style="margin: 0px; padding: 0px;">
                                    ...
                                    <td style="margin: 0px; padding: 0px; font-size: 11px; width: 189px;" 
                                        valign="top">
                                        <table cellpadding="0" cellspacing="0" style="margin: 0px; padding: 0px;">
                                            <tbody style="margin: 0px; padding: 0px;">
                                                <tr style="margin: 0px; padding: 0px;">
                                    ...
                                    <td height="121" style="margin: 0px; padding: 0px;" valign="top" width="180">
                                        <div style="margin: 0px; padding: 0px; position: relative; width: 180px; height: 121px;">
                                            ...
                                            <img height="121" 
                                                ...
                                                style="margin: 0px; padding: 0px; border: none;" title="Renault" width="180" /></a></div>
                                    </td>
                                    <td style="margin: 0px; padding: 0px;" valign="top" width="8">
                                    </td>
                                    <td style="margin: 0px; padding: 0px; font-size: 11px;" valign="top" 
                                    ...
                                    <td height="121" style="margin: 0px; padding: 0px;" valign="top" width="180">
                                        <div style="margin: 0px; padding: 0px; position: relative; width: 180px; height: 121px;">
                                            <div style="margin: 0px; padding: 0px; position: absolute; right: 0px; bottom: 5px;">
                                                <img src="http://www.joaomaiaautomoveis.com/images/barra_novo.jpg" 
                                                    style="margin: 0px; padding: 0px; border: none;" width="80" /></div>
                                            <div style="margin: 0px; padding: 0px; position: absolute; left: 0px; top: 0px;">
                                                <img height="121" 
                                                    src="http://www.joaomaiaautomoveis.com/images/barra_reservado.png" 
                                                    style="margin: 0px; padding: 0px; border: none;" width="180" /></div>
                                            ...
                                            <img height="121" 
                                                ...
                                                style="margin: 0px; padding: 0px; border: none;" title="Volvo" width="180" /></a></div>
                                    </td>
                                    <td style="margin: 0px; padding: 0px;" valign="top" width="8">
                                    </td>
                                    <td style="margin: 0px; padding: 0px; font-size: 11px;" valign="top" 
