    ...
    <p>
        <asp:DetailsView ID="DetailsView2" runat="server" AllowPaging="True" 
            ...
            <Fields>
                ...
                <asp:BoundField DataField="Noticias" HeaderText="Noticias" 
                    SortExpression="Noticias" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            <InsertParameters>
                ...
                <asp:Parameter Name="Noticia" Type="String" />
            </InsertParameters>
            <UpdateParameters>
                <asp:Parameter Name="Nome" Type="String" />
                <asp:Parameter Name="Noticia" Type="String" />
    ...
    <p>
        ...
        <asp:FormView ID="FormView1" runat="server" AllowPaging="True" 
            ...
            <EditItemTemplate>
                ...
                <br />
                Noticias:
                <asp:TextBox ID="NoticiasTextBox" runat="server" 
                    Text='<%# Bind("Noticias") %>' />
                <br />
            ...
            <ItemTemplate>
                ...
                <br />
                Noticias:
                <asp:Label ID="NoticiasLabel" runat="server" Text='<%# Bind("Noticias") %>' />
                <br />
